from .views import error_rates_by_endpoint, p95_p99_latency, request_volume_over_time,mau_dau, api_usage_patterns, average_time_per_endpoint, estimate_user_year_stats, get_latest_precomputed_metrics
...
urlpatterns = [
    ...
    path('metrics/', get_latest_precomputed_metrics, name='get_latest_precomputed_metrics'),
]
