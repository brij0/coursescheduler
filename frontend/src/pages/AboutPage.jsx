...
// Extract AnimatedLines to be defined OUTSIDE the AboutPage component
const AnimatedLines = () => {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="absolute inset-0">
          {/* FIX: Animated lines were beneath the grid (z-10) and used non-standard z-5 (not in default Tailwind). 
              Move lines ABOVE grid and give them a valid higher z-index */}
