...
const GPACalculatorPage = () => {
  ...
  const fetchOfferedTerms = async () => {
    try {
      const response = await fetch('/api/gpacalc/offered_terms/', {
        credentials: 'include'
      })
  ...
  const fetchCourseTypes = async (courseId) => {
    ...
    try {
      const response = await fetch('/api/gpacalc/course_types/', {
        method: 'POST',
  ...
  const fetchCourseCodes = async (courseId, courseType) => {
    ...
    try {
      const response = await fetch('/api/gpacalc/course_codes/', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        credentials: 'include',
        body: JSON.stringify({ 
  ...
  const fetchSectionNumbers = async (courseId, courseType, courseCode) => {
    ...
    try {
      const response = await fetch('/api/gpacalc/section_numbers/', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        credentials: 'include',
        body: JSON.stringify({ 
  ...
  const fetchCourseEvents = async (courseId, courseType, courseCode, sectionNumber) => {
    ...
    try {
      const response = await fetch('/api/gpacalc/course_events/', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        credentials: 'include',
        body: JSON.stringify({ 
  ...
  const calculateGPA = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/gpacalc/calculate/', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        credentials: 'include',
  ...
  const exportToExcel = async () => {
    try {
      const response = await fetch('/api/gpacalc/progress_export_excel/', {
        credentials: 'include'
      })
